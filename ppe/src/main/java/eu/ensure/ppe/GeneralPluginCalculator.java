...
public class GeneralPluginCalculator {
    private static final Logger log = LogManager.getLogger(GeneralPluginCalculator.class);
    ...
    /*
        ...
        LEFT OUTER JOIN ppe_opinions o ON (
           ...
           AND  LOWER(o.providerid) = 'amazon'
           AND  LOWER(o.systemid) = 's3'
        )
        WHERE LOWER(w.purpose) = 'evidence';


        CALL SYSCS_UTIL.SYSCS_SET_RUNTIMESTATISTICS(0);

        SELECT st.stmt_text, sp.no_visited_pages, sp.no_visited_rows, rs.op_identifier, sp.scan_object_name
         FROM  app.sysxplain_scan_props sp,
               app.sysxplain_resultsets rs,
               app.sysxplain_statements st
    ...
    */
    ...
    /*
Column 'W.ASSESSMENTID' is either not in any table in the FROM list
...
or appears in a HAVING clause and is not in the GROUP BY list.
    ...
    public GeneralPluginCalculator(DataSource dataSource) {
                    ...
                    if (!rs.wasNull()) {
                        ...
                        if (weight > 1 && outcome < weight) {
                            ...
                            description.append("The plugin \"")
                               .append(providerId).append("/").append(systemId)
                            ...
                            if (log.isInfoEnabled()) {
                                log.info("Consequence: " + description.toString());
                            }
                            ...
                            story.append("purpose=\"").append(purpose).append("\"")
                                 ...
                                 .append(" plugin=\"").append(providerId).append("/").append(systemId).append("\"")
