...
public class StoragePlugin extends LocalizedPlugin {
    ...
    public StoragePlugin(String pluginId, String serviceProvider, String systemId, String locality, String type, String description, Visibility visibility) {
    ...
    public String toString() {
        ...
        buf.append("\n        [").append("StoragePlugin (").append(pluginId).append(") \"").append(getDescription()).append("\"");
