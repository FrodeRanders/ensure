                            ...
                            case US: // Unsigned short
                                ...
                                // BinaryValueType.USHORT
                                {
                                    ...
                                    if (_us.length <= 80) {
                                        ...
                                        value = "<data size=" + org.gautelis.vopn.lang.Number.asHumanApproximate(_us.length) + ">";
                                    }
                            ...
                            case UL: // Unsigned long
                                ...
                                // BinaryValueType.INT
                                {
                                    ...
                                    if (_ul.length <= 80) {
                                        ...
                                        value = "<data size=" + org.gautelis.vopn.lang.Number.asHumanApproximate(_ul.length) + ">";
                                    }
                            ...
                            case OB: // Other byte string
                                ...
                                // BinaryValueType.BYTE
                                {
                                    ...
                                    if (_ob.length <= 80) {
                                        ...
                                        value = "<data size=" + org.gautelis.vopn.lang.Number.asHumanApproximate(_ob.length) + ">";
                                    }
                            ...
                            case OW: // Other word string
                                ...
                                // BinaryValueType.SHORT
                                {
                                    ...
                                    if (_ow.length <= 80) {
                                        ...
                                        value = "<data size=" + org.gautelis.vopn.lang.Number.asHumanApproximate(_ow.length) + ">";
                                    }
                            ...
                            case UN: // Unknown
                                // BinaryValueType.BYTE
                                {
                                    ...
                                    if (_un.length <= 80) {
                                        ...
                                        value = "<data size=" + org.gautelis.vopn.lang.Number.asHumanApproximate(_un.length) + ">";
                                    }
